...
{
	header("location:searchcriminalcountry.php");
}
...
{   $name=$_POST['name'];
 ...
 ?>
<script type="text/javascript">windows.location="searchcriminalcountry.php";</script>
	<?php
    }
	else
	{	
...
<?php
	...
	$sql="SELECT *FROM criminalcountry where name='$name'and height='$height'";
	...
	<tr><img src='data:image;base64,".base64_encode($rows['image'])."' style='width:100px;height:100px;'></tr>
	 ...
	 <td height=100 width=100>".$rows['country']."</td>
...
{
	?>
	<script>window.location="addcriminalcountry.php";</script>
<?php
}
?>
